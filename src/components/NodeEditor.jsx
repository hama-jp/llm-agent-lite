...
const nodeTypes = {
  ...
  llm: { name: 'LLM生成', icon: '🤖', color: 'bg-gradient-to-br from-blue-400 to-blue-600', borderColor: 'border-blue-300', textColor: 'text-white', inputs: ['input'], outputs: ['output'], defaultData: { temperature: 1.0, model: 'gpt-5-nano', provider: 'openai', baseUrl: '' } },
  ...
  readFile: { name: 'ファイル読込', icon: '📄', color: 'bg-gradient-to-br from-gray-400 to-gray-600', borderColor: 'border-gray-300', textColor: 'text-white', inputs: ['filePath'], outputs: ['content'], defaultData: { filePath: '' } },
  writeFile: { name: 'ファイル書込', icon: '💾', color: 'bg-gradient-to-br from-gray-500 to-gray-700', borderColor: 'border-gray-400', textColor: 'text-white', inputs: ['filePath', 'content'], outputs: [], defaultData: { filePath: '', content: '' } },
  listDirectory: { name: 'フォルダ一覧', icon: '📂', color: 'bg-gradient-to-br from-gray-400 to-gray-600', borderColor: 'border-gray-300', textColor: 'text-white', inputs: ['filePath'], outputs: ['items'], defaultData: { filePath: '' } },
